...
const double flutterAppBarIconSize = 20;
const double flutterAppBarTextFontSize = 16;

const flutterAppBarTextStyle = TextStyle(
    color: Color(0xFF1D1D1D),
    fontSize: flutterAppBarTextFontSize,
    fontWeight: FontWeight.bold);
const flutterAppBarIconThemeData =
    IconThemeData(color: Color(0xFF1D1D1D), size: flutterAppBarIconSize);
...
class FlutterAppBar extends StatefulWidget implements PreferredSizeWidget {
  FlutterAppBar({
    ...
    this.brightness,
    this.iconTheme = flutterAppBarIconThemeData,
    this.textTheme = const TextTheme(title: flutterAppBarTextStyle),
    this.primary = true,
    this.centerTitle,
    ...
    this.gradientEnd,
        ...
        preferredSize = Size.fromHeight(
            kMinInteractiveDimension + (bottom?.preferredSize?.height ?? 0.0)),
        super(key: key);
